...
$pageTitle = "Mechanics | " . $CONSTANTS['APP_NAME'];
                ...
                <div class="row d-sm-flex flex-sm-row align-items-sm-center">
                    <div class="col-12 text-center">
                        <div class="section-header">
                            <h2>Mechanics <?php echo $_GET['mode']; ?></h2>
                        </div>
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button type="button" class="btn btn-primary" id="btn-mechanics-list"><i class="fa fa-list"></i> Mechanics List</button>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-sm-12 mt-3">
                                <div class="text-left">
                                    ...
                                    <input type="text" class="form-control" id="input-name" placeholder="Pro Mechanic">
                                </div>
                            </div>
                            <div class="col-sm-12 mt-3">
                                <div class="text-left">
