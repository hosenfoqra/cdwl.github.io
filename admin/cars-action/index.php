...
$pageTitle = "Cars | " . $CONSTANTS['APP_NAME'];
                ...
                <div class="row d-sm-flex flex-sm-row align-items-sm-center">
                    <div class="col-12 text-center">
                        <div class="section-header">
                            <h2>Car <?php echo $_GET['mode']; ?></h2>
                        </div>
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button type="button" class="btn btn-primary" id="btn-cars-list"><i class="fa fa-list"></i> Cars List</button>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-sm-12 mt-3">
                                <div class="text-left">
                                    <label for="input-manufacturer">Manufacturer <code>*</code></label>
                                    <input type="text" class="form-control" id="input-manufacturer" placeholder="Renault">
                                </div>
                            </div>
                            <div class="col-sm-12 mt-3">
                                <div class="text-left">
                                    <label for="input-logo">Logo <code>*</code></label>
                                    <input type="text" class="form-control" id="input-logo" placeholder="logo file path">
                                </div>
                            </div>
                            <div class="col-sm-12 mt-3">
