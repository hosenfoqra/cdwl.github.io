...
$pageTitle = "Warning Lights | " . $CONSTANTS['APP_NAME'];
                ...
                <div class="row d-sm-flex flex-sm-row align-items-sm-center">
                    <div class="col-12 text-center video-info">
                        <div class="section-header">
                            ...
                            <p>Manage warning lights</p>
                        </div>
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button type="button" class="btn btn-primary" id="btn-add-new-warning-light"><i class="fa fa-plus"></i> Add New Warning Light</button>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered" id="warning-lights-table">
                                    <thead>
                                    <tr>
                                        <th scope="col">#</th>
