                    ...
                    <div class="col-12 text-center video-info">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button type="button" class="btn btn-primary" id="btn-add-new-mechanic"><i class="fa fa-plus"></i> Add New Mechanic</button>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered" id="mechanics-table">
                                    <thead>
                                    <tr>
                                        <th scope="col">#</th>
