                    ...
                    <div class="col-12 text-center video-info">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button type="button" class="btn btn-primary" id="btn-add-new-garage"><i class="fa fa-plus"></i> Add New Garage</button>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered" id="garages-table">
                                    <thead>
                                    <tr>
                                        <th scope="col">#</th>
