...
import { API_MECHANICS } from '../constants/API.js';
...
class Mechanics {
    ...
    async getAllDataFromServer() {
        const requestData = {
            controller: API_MECHANICS.CONTROLLER,
            method: API_MECHANICS.METHODS.GET_ALL_RECORDS
        }
    ...
    async getAllSubModels() {
        const requestData = {
            controller: API_MECHANICS.CONTROLLER,
            method: API_MECHANICS.METHODS.GET_ALL_SUB_MODELS
        }
        const response = await Request.send('GET', requestData)
        return response
    }
    ...
    async getRecordById(_id) {
        const requestData = {
            controller: API_MECHANICS.CONTROLLER,
            method: API_MECHANICS.METHODS.GET_RECORD_BY_ID,
            params: {
                id: _id
            }
        }
    ...
    async updateRecordData(_id, _data) {
        const requestData = {
            controller: API_MECHANICS.CONTROLLER,
            method: API_MECHANICS.METHODS.UPDATE_RECORD_DATA,
            params: {
                id: _id,
                ..._data
            }
    ...
    async createNewRecord(_data) {
        const requestData = {
            controller: API_MECHANICS.CONTROLLER,
            method: API_MECHANICS.METHODS.CREATE_NEW_RECORD,
            params: {
                ..._data
            }
        }
    ...
    async deleteRecord(_recordId) {
        const requestData = {
            controller: API_MECHANICS.CONTROLLER,
            method: API_MECHANICS.METHODS.DELETE_RECORD,
            params: {
                id : _recordId
            }
        }
